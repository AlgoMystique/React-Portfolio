    ...
    <section id="education-and-experience" className="mt-20 mx-4 lg:mx-20 flex flex-col md:flex-row gap-4 md:gap-2">
      ...
      <div className="w-full md:w-[80%]">
        ...
        <div
          ...
          className="relative mt-4 flex justify-center items-center" // Centering the carousel container
        >
          <div className="hs-carousel relative overflow-hidden w-full max-w-[800px] h-48 bg-white dark:bg-gray-800 rounded-lg">
            ...
            return (
              <div key={index}>
                ...
                <div className="flex gap-x-3 relative group rounded-lg">
                  ...
                  <div className="grow p-2 pb-8">
                    <h3 className="flex items-center gap-x-2 font-semibold text-zinc-800 dark:text-white">
                      <img className="w-9 h-9 rounded-full" src={exp.image} alt="Company Logo" />
                      <div className="leading-5">
                        {exp.company}
                        <p className="font-normal text-xs text-zinc-600 dark:text-zinc-400">
                          {exp.role}
